package org.stackoverflow.analysis.lock;
...
import org.stackoverflow.analysis.zookeeper.CuratorFrameworkUtil;
...
public class DistributedLock {
	...
	static {
		...
		try {
			...
			interProcessMutex = new InterProcessMutex(curatorFramework, AnalyticsConfigUtil.getProperties().getProperty("analytics.distributed.lock.path"));
